// Экспорт объекта с конфигурациями датчиков для различных систем
export const sensors = {
    // Данные для скважин
    well: {
        // Давление (Бар)
        pressure: {
            normal: { min: 50, max: 70 }, // Нормальный диапазон
            warning: { min: 71, max: 90 }, // Диапазон предупреждения
            critical: { min: 91 } // Критический диапазон
        },
        // Температура (°C)
        temperature: {
            normal: { min: 50, max: 80 }, // Нормальный диапазон
            warning: { min: 81, max: 100 }, // Диапазон предупреждения
            critical: { min: 91 } // Критический диапазон
        },
        // Обводненность (%)
        flooding: {
            normal: { min: 0, max: 30 }, // Нормальный диапазон
